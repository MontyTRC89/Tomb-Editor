...
public static class IniScriptPatterns
{
	public static string Comments => ";.*$";
	public static string Sections => @"\[\b(" + string.Join("|", IniScriptLanguageConstants.Sections) + @")\b\]";
	public static string StandardCommands => @"\b(" + string.Join("|", IniScriptLanguageConstants.OldCommands) + @")\b\s*=";
	public static string NewCommands => @"\b(" + string.Join("|", IniScriptLanguageConstants.NewCommands) + @")\b\s*=";
	public static string NextLineKey => @">\s*(;.*)?$";
	public static string Mnemonics => @"\b(" + string.Join("|", MnemonicData.AllConstantFlags) + @")\b";
	public static string HexValues => @"\$[a-fA-F0-9]+*";
