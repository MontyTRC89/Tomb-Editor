	...
	public static class TemplatePaths
	{
		public static string GetSharedTemplatesPath(TRVersion.Game gameVersion)
		{
			switch (gameVersion)
			{
				...
				case TRVersion.Game.TombEngine: return Path.Combine(DefaultPaths.ProgramDirectory, "TIDE", "Templates", "TEN");
				default: return null;
			}
		}
		...
		public static string GetDefaultTemplatesPath(TRVersion.Game gameVersion)
		{
			switch (gameVersion)
			{
				...
				case TRVersion.Game.TombEngine: return Path.Combine(DefaultPaths.ProgramDirectory, "TIDE", "Templates", "TEN", "Defaults");
				default: return null;
			}
		}
	}
