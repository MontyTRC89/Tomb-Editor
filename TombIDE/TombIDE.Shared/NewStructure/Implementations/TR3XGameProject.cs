...
{
    public class TR3XGameProject : GameProjectBase
    {
        ...
        public override TRVersion.Game GameVersion => TRVersion.Game.TR3X;

        public override string DataFileExtension => ".tr2";

        public override string EngineExecutableFileName => "TRX.exe";
        ...
        public TR3XGameProject(TrprojFile trproj, Version targetTrprojVersion) : base(trproj, targetTrprojVersion)
        { }

        public TR3XGameProject(string name, string directoryPath, string levelsDirectoryPath)
        ...
        public override Version GetLatestEngineVersion()
        {
            ...
            try
            {
                string enginePresetPath = Path.Combine(DefaultPaths.PresetsDirectory, "TR3X.zip");
