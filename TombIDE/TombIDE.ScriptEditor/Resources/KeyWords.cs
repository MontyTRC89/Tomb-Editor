...
namespace TombIDE.ScriptEditor.Resources
{
	public class KeyWords
	{
		...
		private static string[] GetMnemonicConstants()
		{
			...
			try
			{
				string xmlPath = Path.Combine(PathHelper.GetReferencesPath(), "Mnemonic Constants.xml");
		...
		private static PluginMnemonic[] GetPluginMnemonics()
		{
			...
			try
			{
				foreach (string file in Directory.GetFiles(PathHelper.GetInternalNGCPath(), "plugin_*.script", SearchOption.TopDirectoryOnly))
				{
