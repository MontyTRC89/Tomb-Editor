...
namespace TombIDE.ScriptingStudio
{
	public sealed class ClassicScriptStudio : StudioBase
	{
		...
		public ClassicScriptStudio() : base(IDE.Global.Project.ScriptDirectoryPath, IDE.Global.Project.GetEngineRootDirectoryPath())
		{
			...
			string initialFilePath = PathHelper.GetScriptFilePath(IDE.Global.Project.ScriptDirectoryPath, TombLib.LevelData.TRVersion.Game.TR4);
