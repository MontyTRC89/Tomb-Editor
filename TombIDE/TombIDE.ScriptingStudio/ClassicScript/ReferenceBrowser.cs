...
namespace TombIDE.ScriptingStudio.ClassicScript
{
	...
	{
		private readonly ClassicScriptReferenceBrowserDataProvider _dataProvider = new ClassicScriptReferenceBrowserDataProvider();
		...
		private void UpdateDataGrid()
		{
			...
			try
			{
				DataTable dataTable = _dataProvider.GetTable((ReferenceItemType)treeView.SelectedNodes[0].Tag);
