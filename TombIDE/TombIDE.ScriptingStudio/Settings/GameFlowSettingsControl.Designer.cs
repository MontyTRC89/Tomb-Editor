...
{
	partial class GameFlowSettingsControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.colorButton_SpecialProperties = new DarkUI.Controls.DarkButton();
			...
			this.colorButton_SpecialProperties.Checked = false;
			this.colorButton_SpecialProperties.ContextMenuStrip = this.buttonContextMenu;
			...
			this.groupBox_Colors.Controls.Add(this.colorButton_SpecialProperties);
		...
		private DarkUI.Controls.DarkButton colorButton_SpecialProperties;
