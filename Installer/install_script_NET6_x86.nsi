...
$\r$\n\
  ...
  ${U+2022} Installed .NET Core 6 or later (32-bit)$\r$\n\
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Configs\TextEditors\Tomb1MainConfiguration.xml"
  Delete "$INSTDIR\Configs\TextEditors\LuaConfiguration.xml"
  Delete "$INSTDIR\Configs\TextEditors\GameFlowScriptConfiguration.xml"
  Delete "$INSTDIR\Configs\TextEditors\ClassicScriptConfiguration.xml"
  Delete "$INSTDIR\Configs\TombIDEProjects.xml"
  Delete "$INSTDIR\Configs\TombIDEConfiguration.xml"
