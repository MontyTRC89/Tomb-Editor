...
Section "Uninstall"
  ...
  Delete "$INSTDIR\TIDE\Templates\Sounds\TR3.zip"
  Delete "$INSTDIR\TIDE\Templates\Sounds\TR2.zip"
  ...
  Delete "$INSTDIR\TIDE\Templates\Presets\TR3X.zip"
  ...
  Delete "$INSTDIR\TIDE\Templates\Defaults\Game Icons\TR3X.ico"
  ...
  Delete "$INSTDIR\Resources\ClassicScript\Descriptions\MnemonicConstants.md"
  Delete "$INSTDIR\Resources\ClassicScript\Descriptions\NewCommands.md"
  Delete "$INSTDIR\Resources\ClassicScript\Descriptions\OCBs.md"
  Delete "$INSTDIR\Resources\ClassicScript\Descriptions\OldCommands.md"
  Delete "$INSTDIR\Resources\ClassicScript\VariablePlaceholders.json"
  Delete "$INSTDIR\Resources\ClassicScript\TRNG Script Reference Manual.pdf"
  Delete "$INSTDIR\Resources\ClassicScript\StaticObjectIndices.json"
  Delete "$INSTDIR\Resources\ClassicScript\SoundIndices.json"
  Delete "$INSTDIR\Resources\ClassicScript\Commands.json"
  Delete "$INSTDIR\Resources\ClassicScript\Syntaxes\CustSyntaxes.json"
  Delete "$INSTDIR\Resources\ClassicScript\Syntaxes\NewCommandSyntaxes.json"
  Delete "$INSTDIR\Resources\ClassicScript\Syntaxes\OldCommandSyntaxes.json"
  Delete "$INSTDIR\Resources\ClassicScript\Syntaxes\ParamSyntaxes.json"
  Delete "$INSTDIR\Resources\ClassicScript\OCBList.json"
  Delete "$INSTDIR\Resources\ClassicScript\MoveableSlotIndices.json"
  Delete "$INSTDIR\Resources\ClassicScript\MnemonicConstants.json"
  Delete "$INSTDIR\Resources\ClassicScript\KeyboardScancodes.json"
  Delete "$INSTDIR\Resources\ClassicScript\EnemyDamageValues.json"
  ...
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\TRX\VS15.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\TRX\Obsidian.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\TRX\NG_Center.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\TRX\Monokai.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\TRX\VS15.trxsch"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\TRX\Obsidian.trxsch"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\TRX\NG_Center.trxsch"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\TRX\Monokai.trxsch"
  ...
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\GameFlowScript\VS15.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\GameFlowScript\Obsidian.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\GameFlowScript\NG_Center.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\GameFlowScript\Monokai.json"
  ...
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\ClassicScript\VS15.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\ClassicScript\Obsidian.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\ClassicScript\NG_Center.json"
  Delete "$INSTDIR\Configs\TextEditors\ColorSchemes\ClassicScript\Monokai.json"
  ...
  Delete "$INSTDIR\TombLib.Scripting.TRX.dll"
  Delete "$INSTDIR\TombLib.Scripting.TRX.deps.json"
  ...
  Delete "$INSTDIR\DirectXTexNet.dll"
  ...
  RMDir "$INSTDIR\Configs\TextEditors\ColorSchemes\TRX"
