...
/// <summary>
/// Routes <see cref="DarkMessageBox"/> calls (used throughout the shared editor code) onto the
/// WPF <see cref="CMessageBox"/> so message boxes match the WPF shell instead of opening the
/// WinForms dialog. Installed by <see cref="Program"/> for the WPF shell only; the legacy
/// --winforms shell keeps the WinForms dialog.
/// </summary>
