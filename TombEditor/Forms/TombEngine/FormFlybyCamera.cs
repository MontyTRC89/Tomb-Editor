...
namespace TombEditor.Forms.TombEngine
{
    public partial class FormFlybyCamera : DarkForm
    {
        ...
        private void FormFlybyCamera_Load(object sender, EventArgs e)
        {
            ...
            tbLuaName.Text = _flyByCamera.LuaName;

            // FIXME: FOR MONTY AND TEAM!!!!
            // TR4 bit 15 flag values was reassigned to HIDE LARA feature (in TR5 it was bit 4).
        }

        private void butOK_Click(object sender, EventArgs e)
        {
            if (!_flyByCamera.TrySetLuaName(tbLuaName.Text, this))
                return;
