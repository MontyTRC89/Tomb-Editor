...
namespace TombEditor.Geometry.IO
{
    ...
    internal static class Prj2Chunks
    {
        ...
        /******/public static readonly ChunkID SoundPath = ChunkID.FromString("TeSoundPath"); // UTF-8 string
        ...
        /**********/public static readonly ChunkID TextureSounds = ChunkID.FromString("TeTextureSounds");
