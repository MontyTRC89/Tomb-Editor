...
namespace TombEditor.ToolWindows
{
    public partial class ItemBrowser : DarkToolWindow
    {
        ...
        private ItemType? GetCurrentItemWithMessage()
        {
            ...
            if (result == null)
                Editor.Instance.SendMessage("Select an item first.", PopUpInfo.PopupType.Error);
            return result;
        }
        ...
        public void FindItem()
        {
            ...
            // Show result
            if (instance == null)
                Editor.Instance.SendMessage("No object of the selected item type found.", PopUpInfo.PopupType.Info);
            else
        ...
        private void butAddItem_Click(object sender, EventArgs e)
        {
            ...
            {
                Editor.Instance.SendMessage("You can't add moveables to a flipped room.", PopUpInfo.PopupType.Info);
                return;
            }
