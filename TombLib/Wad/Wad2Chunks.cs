...
namespace TombLib.Wad
{
    class Wad2Chunks
    {
        ...
        public static readonly ChunkId TrNgWad = ChunkId.FromString("W2TrNgWad");
        public static readonly ChunkId SoundManagementSystem = ChunkId.FromString("W2SoundMgmt");
