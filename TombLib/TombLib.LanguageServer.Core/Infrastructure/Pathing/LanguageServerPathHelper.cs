...
{
	private const string UseCaseSensitiveLocalPathsSwitch = "TombLib.LanguageServer.Core.UseCaseSensitiveLocalPaths";
	private const string UseCaseInsensitiveLocalPathsSwitch = "TombLib.LanguageServer.Core.UseCaseInsensitiveLocalPaths";
