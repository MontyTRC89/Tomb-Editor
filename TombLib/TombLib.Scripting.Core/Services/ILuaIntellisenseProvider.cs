...
namespace TombLib.Scripting.Core.Lua;

/// <summary>
/// Defines the language-service contract used by the Lua editor to provide IntelliSense features.
/// </summary>
/// <remarks>
...
/// </remarks>
public interface ILuaIntellisenseProvider : IDisposable, ITextEditProvider, ITextReferencesProvider
{
	/// <summary>
