...
namespace TombLib.Utils
{
    ...
    public class Conversions
    {
        public class SoundInfoConversionRow
        {
            ...
            public SoundInfoConversionRow(WadSoundInfo info)
            {
                SoundInfo = info;
                NewId = -1;
                SaveToXml = false;
        ...
        public static bool ConvertWad2ToNewSoundFormat(string src, string dest, string soundsCatalog)
        {
            try
            {
                ...
                if (wad.SoundSystem != WadSoundSystem.Dynamic)
                ...
                {
                    var row = new SoundInfoConversionRow(soundInfo);
                ...
                wad.SoundSystem = WadSoundSystem.Xml;
