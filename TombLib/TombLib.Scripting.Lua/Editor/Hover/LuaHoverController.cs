...
public sealed partial class LuaEditor
{
	...
	private sealed class LuaHoverController
	{
		...
		private TextHoverRequestState BuildRequestState(int hoveredOffset)
		{
			...
			bool canShowToolTip = TextPopupInteractionRules.CanShowHover(_editor._completionWindow is not null, _editor._signatureHelpController.IsVisible);
			int hoverOffset = 0;
		...
		{
			if (!TextPopupInteractionRules.CanShowHover(_editor._completionWindow is not null, _editor._signatureHelpController.IsVisible))
				return null;
