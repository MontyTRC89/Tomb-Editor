...
--!Arguments "NewLine, Enumeration, 100, [Opaque | Alpha test | Add | No Z test | Subtract | Wireframe | Exclude | Screen | Lighten | Alpha blend], Blending method for particles"
...
--!Arguments "NewLine, Moveables, 70, Shockwave position" "Numerical, 30, [0 | 100], Mesh number/n(optional)"
