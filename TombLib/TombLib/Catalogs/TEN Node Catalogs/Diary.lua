...
-- !Name "Create a diary"
-- !Section "Diary"
-- !Description "Start a new diary with specified name."
-- !Arguments "NewLine, 100, WadSlots, [ _ITEM ], {TEN.Objects.ObjID.DIARY_ITEM}, Object to call the diary with in Lara's inventory."
-- !Arguments "Newline, SpriteSlots, 60, {TEN.Objects.ObjID.DIARY_SPRITES}, Background sprite sequence object ID"
-- !Arguments "Number, 20, [ 0 | 9999 | 0 ],{0}, Sprite ID for background in sprite sequence\nRange[0 to 9999]"
...
-- !Arguments "Number, 20, [ -1000 | 1000 | 2 ], {50}, Position Y (%)\nRange [-1000 to 1000]\nVisible range [0 to 100]"
...
-- !Arguments "Number, 15, [ 0 | 255 | 0 ], {255}, Alpha Blend for Diary sprite"
...
-- !Name "Add background image to diary"
-- !Section "Diary"
-- !Description "Add post process effect to the diary background."
-- !Arguments "NewLine, 100, WadSlots, [ _ITEM ], {TEN.Objects.ObjID.DIARY_ITEM}, Object to call the diary with in Lara's inventory."
-- !Arguments "Newline, SpriteSlots, 60, {TEN.Objects.ObjID.DIARY_SPRITES}, Background sprite sequence object ID"
...
-- !Arguments "Enumeration, 28, [ Opaque | Alpha Test | Additive | No Z Test | Subtractive | Wireframe | Exclude | Screen | Lighten | Alphablend ], {9}, Blend mode"
-- !Arguments "Number, 15, {128}, [ 0 | 255 | 2 ], Alpha [0 to 255]"
...
-- !Name "Customize notifications for the diary"
-- !Section "Diary"
-- !Description "Customize notification systems for the diary."
-- !Arguments "NewLine, 80, WadSlots, [ _ITEM ], {TEN.Objects.ObjID.DIARY_ITEM}, Diary Object to add notification." "Numerical, 20, [ 1 | 65535 ], {3}, Notification Time"
...
-- !Arguments "Number, 20, [ -1000 | 1000 | 2 ],{95}, Position Y (%)\nRange [-1000 to 1000]\nVisible range [0 to 100]"
-- !Arguments "Number, 20, [ 0 | 360 | 2 ], Rotation\nRange [0 to 360]"
-- !Arguments "Number, 20, {5}, [ 0 | 1000 | 2 ], Scale X (%)\nRange [0 to 1000]"
-- !Arguments "Number, 20, {5}, [ 0 | 1000 | 2 ], Scale Y (%)\nRange [0 to 1000]"
-- !Arguments "NewLine, Enumeration, 35, [ Center | Center Top | Center Bottom | Center Left | Center Right | Top Left | Top Right | Bottom Left | Bottom Right ], {0}, Align mode"
-- !Arguments "Enumeration, 22, [ Fit | Fill | Stretch ], Scale mode"
-- !Arguments "Enumeration, 28, [ Opaque | Alpha Test | Additive | No Z Test | Subtractive | Wireframe | Exclude | Screen | Lighten | Alphablend ], {9}, Blend mode"
...
-- !Section "Diary"
-- !Description "Add a new entry with to a diary."
-- !Arguments "NewLine, 80, WadSlots, [ _ITEM ], {TEN.Objects.ObjID.DIARY_ITEM}, Diary Object to add an entry." "Numerical, 20, [ 1 | 65535 ], {1}, Page Number to text entry."
...
-- !Section "Diary"
-- !Description "Add a new entry with to a diary."
-- !Arguments "NewLine, 80, WadSlots, [ _ITEM ], {TEN.Objects.ObjID.DIARY_ITEM}, Diary Object to add an entry." "Numerical, 20, [ 1 | 65535 ], {1}, Page Number to add image entry."
...
-- !Arguments "NewLine, SoundTracks, Name of the audiotrack to add to page"
...
-- !Arguments "NewLine, 80, WadSlots, [ _ITEM ], {TEN.Objects.ObjID.DIARY_ITEM}, Diary Object to unlock pages." 
