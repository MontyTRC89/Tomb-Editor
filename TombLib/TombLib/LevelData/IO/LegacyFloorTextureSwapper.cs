...
public static class LegacyFloorTextureSwapper
{
    /// <summary>
    ...
    /// </summary>
    public static void SwapFloor2FacesWhereApplicable(this Room room, int x, int z)
    {
    ...
    /// </summary>
    public static void SwapCeiling2FacesWhereApplicable(this Room room, int x, int z)
    {
        Block block = room.Blocks[x, z];
    ...
    public static void SwapDiagonalFloor2FacesWhereApplicable(this Room room, int x, int z)
    {
    ...
    public static void SwapDiagonalCeiling2FacesWhereApplicable(this Room room, int x, int z)
    {
        Block localBlock = room.Blocks[x, z],
            probingBlock = localBlock;
