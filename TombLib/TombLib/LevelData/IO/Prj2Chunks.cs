...
namespace TombLib.LevelData.IO
{
    ...
    {        
		...
		/**************/public static readonly ChunkId SectorExtraFloorSubdivisions = new ChunkId(new byte[] { 3 });
		/**************/public static readonly ChunkId SectorExtraCeilingSubdivisions = new ChunkId(new byte[] { 4 });
