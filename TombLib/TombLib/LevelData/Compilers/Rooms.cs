        ...
        private tr_room BuildRoom(Room room)
        {
            ...
            // Generate geometry
            {
                ...
                for (int i = 0; i < roomVertices.Count; ++i)
                {
                    ...
                    {
                        var xv = trVertex.Position.X / (int)Level.BlockSizeUnit;
                        var zv = trVertex.Position.Z / (int)Level.BlockSizeUnit;
        ...
        private void ConvertSectors(Room room, tr_room newRoom)
        {
            ...
            for (var z = 0; z < room.NumZSectors; z++)
            {
                for (var x = 0; x < room.NumXSectors; x++)
                {
                    ...
                    {
                        sector.Floor = (sbyte)(-room.Position.Y.InFullClicks() - block.Floor.Max.InFullClicks());
