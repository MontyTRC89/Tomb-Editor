            ...
            while (stack.Count > 0)
            {
                ...
                for (int i = _boxes[next].OverlapIndex & 0x3fff; i < _overlaps.Length && !last; i++)
                {
                    ...
                    if (zoneType == 1)
                    {
                        ...
                        if (!dec_boxes[boxIndex].Slope && water == isWater && (canJump || step <= Level.FullClickHeight) &&
                    ...
                    if (zoneType == 2)
                    {
                        ...
                        if (!dec_boxes[boxIndex].Slope && water == isWater && step <= Level.FullClickHeight &&
                            (!flipped && dec_boxes[boxIndex].Flag0x04 ||
                            flipped && dec_boxes[boxIndex].Flag0x02))
                            add = true;
                    }
                    ...
                    if (zoneType == 3)
                    {
                        ...
                        if (!dec_boxes[boxIndex].Slope && (water == isWater && step <= Level.FullClickHeight || water) &&
                            (!flipped && dec_boxes[boxIndex].Flag0x04 ||
                            flipped && dec_boxes[boxIndex].Flag0x02)) 
                            add = true;
                    }
