...
namespace TombLib.LevelData.Compilers.Util
{
    ...
    public class ObjectTextureManagerWithAnimations : ObjectTextureManager
    {
        ...
        private readonly Dictionary<Texture, List<AnimationLookupEntry>[,]> _animationSpaceLookup = new Dictionary<Texture, List<AnimationLookupEntry>[,]>(new ReferenceEqualityComparer<Texture>());
        private readonly Dictionary<AnimatedTextureFrame, uint> _animationTextureSpaceIdentifierLookup = new Dictionary<AnimatedTextureFrame, uint>(new ReferenceEqualityComparer<AnimatedTextureFrame>());
