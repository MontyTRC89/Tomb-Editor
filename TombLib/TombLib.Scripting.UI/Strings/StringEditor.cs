...
namespace TombLib.Scripting.UI.Strings
{
	public class StringEditor : DarkTabbedContainer, IEditorControl
	{
		...
		public void UpdateSettings(TombLib.Scripting.UI.Bases.ConfigurationBase configuration) // TODO: Create it's own settings for the StringEditor
		{
