...
namespace WadTool
{
    partial class FormAnimationEditor
    {
		...
		private void InitializeComponent()
		{
			...
			panelRendering = new WadTool.Controls.PanelRenderingAnimationEditor();
			...
			cbRootRotationX = new DarkUI.Controls.DarkCheckBox();
			...
			panelRootMotion = new DarkUI.Controls.DarkSectionPanel();
			cbRootRotationZ = new DarkUI.Controls.DarkCheckBox();
			cbRootRotationY = new DarkUI.Controls.DarkCheckBox();
			...
			bezierCurveEditor = new WadTool.Controls.BezierCurveEditor();
			...
			bcAnimation = new WadTool.Controls.BezierCurveEditor();
			...
			dgvBoundingMeshList.Size = new System.Drawing.Size(278, 472);
			...
			cbRootPosX.Text = "X";
			cbRootPosX.CheckedChanged += cbRootMotion_CheckedChanged;
			// 
			// cbRootPosZ
			// 
			...
			cbRootPosZ.Text = "Z";
			cbRootPosZ.CheckedChanged += cbRootMotion_CheckedChanged;
			// 
			// cbRootRotationX
			// 
			cbRootRotationX.AutoSize = true;
			cbRootRotationX.Location = new System.Drawing.Point(176, 29);
			cbRootRotationX.Name = "cbRootRotationX";
			cbRootRotationX.Size = new System.Drawing.Size(32, 17);
			cbRootRotationX.TabIndex = 102;
			cbRootRotationX.Text = "X";
			cbRootRotationX.CheckedChanged += cbRootMotion_CheckedChanged;
			// 
			// cbRootPosY
			// 
			...
			cbRootPosY.Text = "Y";
			cbRootPosY.CheckedChanged += cbRootMotion_CheckedChanged;
			// 
			// darkLabel33
			// 
			...
			panelRight.Controls.Add(panelRootMotion);
			...
			panelTransform.Location = new System.Drawing.Point(0, 332);
			...
			// panelRootMotion
			// 
			panelRootMotion.Controls.Add(cbRootRotationZ);
			panelRootMotion.Controls.Add(cbRootRotationY);
			panelRootMotion.Controls.Add(darkLabel16);
			panelRootMotion.Controls.Add(cbRootPosX);
			panelRootMotion.Controls.Add(cbRootRotationX);
			panelRootMotion.Controls.Add(cbRootPosZ);
			panelRootMotion.Controls.Add(darkLabel37);
			panelRootMotion.Controls.Add(cbRootPosY);
			panelRootMotion.Dock = System.Windows.Forms.DockStyle.Bottom;
			panelRootMotion.Location = new System.Drawing.Point(0, 444);
			panelRootMotion.Name = "panelRootMotion";
			panelRootMotion.SectionHeader = "Root Motion";
			panelRootMotion.Size = new System.Drawing.Size(280, 54);
			panelRootMotion.TabIndex = 132;
			// 
			// cbRootRotationZ
			// 
			cbRootRotationZ.AutoSize = true;
			cbRootRotationZ.Location = new System.Drawing.Point(244, 29);
			...
			darkLabel16.Location = new System.Drawing.Point(2, 30);
			darkLabel16.Name = "darkLabel16";
			darkLabel16.Size = new System.Drawing.Size(28, 13);
			darkLabel16.TabIndex = 98;
			darkLabel16.Text = "Pos:";
			// 
			// darkLabel37
			// 
			darkLabel37.ForeColor = System.Drawing.Color.FromArgb(220, 220, 220);
			darkLabel37.Location = new System.Drawing.Point(141, 30);
			darkLabel37.Name = "darkLabel37";
			darkLabel37.Size = new System.Drawing.Size(29, 13);
			darkLabel37.TabIndex = 97;
			darkLabel37.Text = "Rot:";
			// 
			// darkSectionPanel5
			// 
        ...
        private DarkUI.Controls.DarkCheckBox cbRootRotationX;
		...
		private DarkUI.Controls.DarkSectionPanel panelRootMotion;
		private DarkUI.Controls.DarkLabel darkLabel16;
		private DarkUI.Controls.DarkLabel darkLabel37;
		private DarkUI.Controls.DarkCheckBox cbRootRotationZ;
		private DarkUI.Controls.DarkCheckBox cbRootRotationY;
	}
}