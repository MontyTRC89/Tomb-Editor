...
namespace TombEditor.WPF
{
    public static class EditorActions
    {
        ...
        public static bool ContinueOnFileDrop(INotifyPropertyChanged owner, string description)
        {
        ...
        public static void EditColor(INotifyPropertyChanged owner, IColorable obj, Action<Vector3> newColorCallback = null)
        {
        ...
        public static void SmoothSector(Room room, int x, int z, BlockVertical vertical, int increment, bool disableUndo = false)
        {
            ...
            room.ChangeBlockHeight(x, z, vertical, BlockEdge.XnZp, Math.Sign(newXnZp - currBlock.Block.GetHeight(vertical, BlockEdge.XnZp)) * increment);
            room.ChangeBlockHeight(x, z, vertical, BlockEdge.XpZp, Math.Sign(newXpZp - currBlock.Block.GetHeight(vertical, BlockEdge.XpZp)) * increment);
            room.ChangeBlockHeight(x, z, vertical, BlockEdge.XpZn, Math.Sign(newXpZn - currBlock.Block.GetHeight(vertical, BlockEdge.XpZn)) * increment);
            room.ChangeBlockHeight(x, z, vertical, BlockEdge.XnZn, Math.Sign(newXnZn - currBlock.Block.GetHeight(vertical, BlockEdge.XnZn)) * increment);
        ...
        public static void AddTrigger(Room room, RectangleInt2 area, INotifyPropertyChanged owner)
        {
            if (Keyboard.Modifiers.HasFlag(Key.LeftShift) || _editor.SelectedObject == null || !(_editor.SelectedObject is PositionBasedObjectInstance))
                AddTrigger(room, area, owner, _editor.BookmarkedObject);
            else
                AddTrigger(room, area, owner, _editor.SelectedObject);
        }

        public static void AddTrigger(Room room, RectangleInt2 area, INotifyPropertyChanged owner, ObjectInstance @object)
        {
        ...
        public static void AddBoxVolumeInSelectedArea(INotifyPropertyChanged owner)
        {
            if (!VersionCheck(_editor.Level.IsTombEngine, "Volume"))
                return;
        ...
        public static Vector3 GetMovementPrecision(Key modifierKeys)
        {
            if (modifierKeys.HasFlag(Key.LeftCtrl))
                return new Vector3(0.0f);
            if (modifierKeys.HasFlag(Key.LeftShift))
        ...
        public static void MoveObject(PositionBasedObjectInstance instance, Vector3 pos, Key modifierKeys)
        {
            MoveObject(instance, pos, GetMovementPrecision(modifierKeys), modifierKeys.HasFlag(Key.LeftAlt));
        }
        ...
        public static void RotateObject(ObjectInstance instance, RotationAxis axis, float angleInDegrees, float quantization = 0.0f, bool delta = true, bool disableUndo = false)
        {
            ...
            {
                case RotationAxis.Y:
                    if (Keyboard.Modifiers.HasFlag(Key.LeftAlt) && instance is ObjectGroup)
                    {
        ...
        public static void RenameObject(ObjectInstance instance, INotifyPropertyChanged owner)
        {
            if (instance == null)
            {
        ...
        public static void EditObject(ObjectInstance instance, INotifyPropertyChanged owner)
        {
            if (instance is MoveableInstance)
            {
                if (instance.CanBeColored() && Keyboard.Modifiers.HasFlag(Key.LeftCtrl))
            ...
            else if (instance is StaticInstance)
            {
                ...
                if (instance.CanBeColored() && (!_editor.Level.IsNG || Keyboard.Modifiers.HasFlag(Key.LeftCtrl)))
                {
        ...
        public static void DeleteObjects(IEnumerable<ObjectInstance> objects, INotifyPropertyChanged owner = null, bool undo = true)
        {
            if (!objects.Any())
                return;
        ...
        public static void DeleteObject(ObjectInstance instance, INotifyPropertyChanged owner = null)
        {
        ...
        public static void EditEventSets(INotifyPropertyChanged owner, bool global, VolumeInstance targetVolume = null)
        {
            var existingWindow = WinFormsApp.OpenForms[nameof(FormEventSetEditor)];
        ...
        public static void SelectObjectsInArea(INotifyPropertyChanged owner, SectorSelection area, bool resetCurrentSelection = true)
        {
        ...
        public static void DeleteRooms(IEnumerable<Room> rooms_, INotifyPropertyChanged owner = null)
        {
            if (!rooms_.Any())
                return;
        ...
        public static void CropRoom(Room room, RectangleInt2 newArea, INotifyPropertyChanged owner)
        {
        ...
        public static void AddPortal(Room room, RectangleInt2 area, INotifyPropertyChanged owner)
        {
        ...
        public static void AlternateRoomDisableWithWarning(Room room, INotifyPropertyChanged owner)
        {
        ...
        public static void MergeRoomsHorizontally(IEnumerable<Room> rooms, INotifyPropertyChanged owner)
        {
            if (rooms.Count() < 2)
            {
            ...
            Action<Room, IEnumerable<Room>, Dictionary<VectorInt2, Room>, bool> performMergeAction =
                (newRoomToHandle, roomsToHandle, newSectorMap, removeObjectsInNotAlternatedRooms) =>
                {
                    ...
                    { // Copy all adjacent sectors of walls
                        ...
                        {
                            foreach (BlockVertical vertical in otherBlockNegativeX.GetVerticals())
                            {
                        ...
                        {
                            foreach (BlockVertical vertical in otherBlockPositiveX.GetVerticals())
                            {
                        ...
                        {
                            foreach (BlockVertical vertical in otherBlockNegativeZ.GetVerticals())
                            {
                        ...
                        {
                            foreach (BlockVertical vertical in otherBlockPositiveZ.GetVerticals())
                            {
        ...
        public static void SplitRoom(INotifyPropertyChanged owner)
        {
            if (!CheckForRoomAndBlockSelection(owner))
                return;
        ...
        public static void DuplicateRoom(INotifyPropertyChanged owner)
        {
        ...
        public static bool CheckForRoomAndBlockSelection(INotifyPropertyChanged owner)
        {
        ...
        public static bool CheckForLockedRooms(INotifyPropertyChanged owner, IEnumerable<Room> rooms)
        {
        ...
        public static void EditLightColor(INotifyPropertyChanged owner)
        {
        ...
        public static bool BuildLevel(bool autoCloseWhenDone, INotifyPropertyChanged owner, bool silent = false, string forceDirectory = null)
        {
        ...
        public static void BuildLevelAndPlay(INotifyPropertyChanged owner, bool fastMode = false)
        {
            if (IsLaraInLevel())
            {
        ...
        public static bool AddAndPlaceImportedGeometry(INotifyPropertyChanged owner, VectorInt2 position, string file)
        {
            if (!File.Exists(file))
                return false;
        ...
        public static IEnumerable<ReferencedWad> AddWad(INotifyPropertyChanged owner, IEnumerable<string> predefinedPaths = null)
        {
            ...
            using (var loadingTask = Task.Run(() =>
                ...
                {
                    Thread.Sleep(1);
					WinForms.Application.DoEvents(); // Keep dialog handler responsive, otherwise wad loading can deadlock waiting on GUI thread, while GUI thread is waiting for Parallel.For.
                }
            ...
            using (var loadingTask = Task.Run(() =>
                ...
                {
                    Thread.Sleep(1);
					WinFormsApp.DoEvents(); // Keep dialog handler responsive, otherwise wad loading can deadlock waiting on GUI thread, while GUI thread is waiting for Parallel.For.
                }
        ...
        public static bool EnsureNoOutsidePortalsInSelecton(INotifyPropertyChanged owner)
        {
        ...
        public static bool TransformRooms(RectTransformation transformation, INotifyPropertyChanged owner)
        {
        ...
        public static void TryCopyObject(ObjectInstance instance, INotifyPropertyChanged owner)
        {
        ...
        public static void TryCopySectors(SectorSelection selection, INotifyPropertyChanged owner)
        {
            Clipboard.SetDataObject(new SectorsClipboardData(_editor));
        }

        public static void TryStampObject(ObjectInstance instance, INotifyPropertyChanged owner)
        {
            if (!(instance is ISpatial))
            {
        ...
        public static void TryPasteSectors(SectorsClipboardData data, INotifyPropertyChanged owner)
        {
            _editor.UndoManager.PushGeometryChanged(_editor.SelectedRoom);
		...
		public static void MoveLara(INotifyPropertyChanged owner, Room targetRoom, VectorInt2 p)
        {
        ...
        public static int DragDropCommonFiles(DragEventArgs e, INotifyPropertyChanged owner)
        {
            if (!e.Data.GetDataPresent(DataFormats.FileDrop))
                return -1;
            string[] files = (string[])e.Data.GetData(DataFormats.FileDrop);
        ...
        public static void SetPortalOpacity(PortalOpacity opacity, INotifyPropertyChanged owner)
        {
        ...
        public static bool SaveLevel(INotifyPropertyChanged owner, bool askForPath)
        {
        ...
        public static void ReplaceObject(INotifyPropertyChanged owner, bool fromContext = false)
        {
            var existingWindow = WinFormsApp.OpenForms[nameof(FormReplaceObject)];
            if (existingWindow == null)
            {
        ...
        public static void ExportCurrentRoom(INotifyPropertyChanged owner)
        {
            ExportRooms(new[] { _editor.SelectedRoom }, owner);
        }

        public static void ExportRooms(IEnumerable<Room> rooms, INotifyPropertyChanged owner)
        {
        ...
        public static void ImportRooms(INotifyPropertyChanged owner)
        {
        ...
        */
        ...
        public static bool OpenLevel(INotifyPropertyChanged owner, string fileName = null, bool silent = false)
        {
        ...
        public static void OpenLevelPrj(INotifyPropertyChanged owner, string fileName = null)
        {
            if (!ContinueOnFileDrop(owner, "Open level"))
                return;
        ...
        public static void SelectRoomsByTags(INotifyPropertyChanged owner)
        {
        ...
        public static void SetStaticMeshesColor(INotifyPropertyChanged owner)
        {
        ...
        public static void MakeQuickItemGroup(INotifyPropertyChanged owner)
        {
        ...
        public static bool AutoLoadSamplePath(LevelSettings settings)
        {
            ...
            var samplePath = WinForms.Application.StartupPath + "\\Assets\\Samples\\";
