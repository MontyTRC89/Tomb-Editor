...
internal sealed class SetDiagonalCeilingStepCommand : RoomGeometryCommand
{
	public SetDiagonalCeilingStepCommand(INotifyPropertyChanged caller, Editor editor, Logger? logger = null) : base(caller, editor, logger)
	{ }
